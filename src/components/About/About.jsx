...
function About() {
  return (
    <section id="about" className="relative py-28 bg-[#050505] overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[450px] h-[450px] bg-purple-700 opacity-10 blur-[180px] rounded-full"></div>

      <div className="absolute bottom-0 left-0 w-[350px] h-[350px] bg-purple-700 opacity-10 blur-[170px] rounded-full"></div>
